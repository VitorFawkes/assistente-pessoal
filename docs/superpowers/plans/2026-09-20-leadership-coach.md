...
Implementação e correções integradas pelos PRs #2 e #3; imagem atual `e79b36d16c6fc9b7bd79c3f40e738adb50a2d25f` publicada e verificada. Migration aplicada; autenticação, isolamento, memória, interface, conversa real e fontes passaram em produção. Runner executado, cron instalado e lock verificado em disparo real. Primeira revisão persistida após cobertura completa do período e idempotência confirmada em rodada posterior. A imagem final passou novamente em conversa, revisão, fontes e recarga no desktop/celular. Histórico antigo continua em processamento sequencial autônomo, com progresso preservado após o rollout. Cobertura completa de todo o acervo não é pressuposto nem resultado alegado desses testes.
