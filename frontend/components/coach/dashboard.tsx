...
export function CoachDashboard() {
  ...
  const [whatsappCode,setWhatsappCode]=useState<string|undefined>(undefined);
  ...
  const refreshState=useCallback(()=>{void load();},[load]);
  ...
  const mutate = useCallback(async (payload: Record<string, unknown>, successMessage?: string): Promise<boolean> => {
    ...
    try {
      ...
      if(typeof next.whatsapp_code==="string")setWhatsappCode(next.whatsapp_code);
      setState(next);
